...
local function createGui()
	if not CoreGui:FindFirstChild("BLRivals") then
		local CoreGui = game:GetService("CoreGui")
		local G2L = {};
		...
		local function C_102()
			...
			local function AutoFarm()
				...
				while JurassicBlocky and #Goats > 0 do
					local currentGoat = Goats[math.random(1, #Goats)]
					local humanoid = currentGoat:FindFirstChild("Humanoid")
					local hrp = currentGoat:FindFirstChild("HumanoidRootPart")
